...
Points[0][0] = np.array([0, 0, 0])
Points[0][1] = np.array([0, 1, 0])
Points[0][2] = np.array([0, 2, 0])
Points[1][0] = np.array([1, 0, 0])
Points[1][1] = np.array([1, 1, 0])
Points[1][2] = np.array([1, 2, 0])
Points[2][0] = np.array([2, 0, 0])
Points[2][1] = np.array([2, 1, 0])
Points[2][2] = np.array([2, 2, 0])
ref_grid = np.full((3, 3), True)
velocity = np.zeros((3, 3, 3))
velocity[1][1] = np.array(([1, 0, 0]))
l0 = np.full(8, 1, dtype=np.float64)
l0[4:] = np.sqrt(2)
