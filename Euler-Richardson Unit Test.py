...
for x in range(50): # Run Euler-Richardson for 5 seconds in 0.1 second chunks
    calc.euler_richardson(coord_change, True)
    calc_cpu.euler_richardson(coord_change, True)
