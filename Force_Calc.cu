__global__ void force_calc(float* output[1001][1001][3], float* pos_grid[1001][1001][3], float* constants[2], float* l0[8],  bool* ref_grid[1001][1001], int* coord_change[8][3], float* divisor[2], float* velocity[1001][1001][3]){
